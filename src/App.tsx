...
export default function App() {
  ...
  const cardsBuy = [
    { title: 'Old AC', desc: 'Split, window & portable AC units', Icon: Wind },
    { title: 'Refrigerator', desc: 'Single & double door fridges', Icon: Refrigerator },
    { title: 'Washing Machine', desc: 'Top & front load machines', Icon: Droplets },
    { title: 'Cooler', desc: 'Air coolers & evaporative units', Icon: Wind },
    { title: 'TV & Electronics', desc: 'LED, LCD, smart TVs & more', Icon: Tv },
    { title: 'Computer & Laptop', desc: 'Desktop PCs, laptops, monitors', Icon: Monitor },
    { title: 'Copper', desc: 'Copper wires, pipes & scrap', Icon: Cable },
    { title: 'Aluminium', desc: 'Aluminium frames, cans & scrap', Icon: Sparkles },
    { title: 'Iron & Steel', desc: 'Iron rods, steel sheets & parts', Icon: ShieldCheck },
    { title: 'Electrical Wires', desc: 'Copper & aluminium wiring', Icon: Cable },
    { title: 'Batteries', desc: 'Car, inverter & UPS batteries', Icon: Battery },
    { title: 'Other Scrap', desc: 'Plastic, cardboard & more', Icon: Recycle },
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-body overflow-x-hidden">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-glow via-[#f0fdf4] to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 pt-10 md:pt-20 lg:pt-28 pb-14 md:pb-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {cardsBuy.map((c) => (
              <div
                key={c.title}
                className="group bg-white rounded-3xl p-7 shadow-[0_4px_30px_rgba(6,78,59,0.04)] ring-1 ring-slate-100 card-hover"
              >
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-glow to-emerald-pale/40 flex items-center justify-center mb-6 shadow-sm group-hover:shadow-md transition-all">
                  <c.Icon className="w-7 h-7 text-emerald-brand" />
                </div>
                <h3 className="font-display font-bold text-xl text-ink mb-2">{c.title}</h3>
                <p className="text-slate-500 text-sm mb-5">{c.desc}</p>
                <a
                  href="#contact"
      ...
      <section id="how" className="py-20 md:py-28 bg-gradient-to-b from-white via-emerald-glow/40 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
          ...
          <div className="grid md:grid-cols-4 gap-6 md:gap-8">
            {[
              { step: '01', title: 'Contact PODDAR', desc: 'Call or WhatsApp us with your scrap details.', Icon: Phone },
              { step: '02', title: 'Tell Us What You Sell', desc: 'Share photos or describe materials you want to sell.', Icon: MessageCircle },
              { step: '03', title: 'Get a Price', desc: 'Receive an instant fair quotation for your items.', Icon: CheckCircle2 },
              { step: '04', title: 'Pickup & Payment', desc: 'We collect from your location and pay you immediately.', Icon: Truck },
            ].map((item, i) => (
              <div key={item.step} className="relative">
                <div className="bg-white rounded-3xl p-7 md:p-8 shadow-[0_4px_30px_rgba(6,78,59,0.04)] ring-1 ring-slate-100 h-full relative overflow-hidden">
                  <div className="absolute top-0 right-0 text-[120px] font-display font-extrabold text-slate-100/60 leading-none select-none -translate-y-6 translate-x-6">
                    {item.step}
                  </div>
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-deep to-emerald-brand flex items-center justify-center shadow-lg shadow-emerald-brand/20 mb-6">
                ...
                {i < 3 && (
                  <div className="hidden md:block absolute top-[52px] -right-3 z-10">
                    <ChevronRight className="w-6 h-6 text-emerald-pale rotate-90 md:rotate-0" />
                  </div>
                )}
              </div>
            ))}
      ...
      <section id="why" className="py-20 md:py-28 bg-stone">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: 'Fair Pricing', desc: 'Market-aligned rates for all scrap categories. No hidden deductions.', Icon: Handshake },
              { title: 'Quick Response', desc: 'Get a quote within minutes. No long waits or complicated processes.', Icon: Clock },
              { title: 'Easy Pickup', desc: 'We come to your doorstep — homes, offices, shops and factories.', Icon: Truck },
              { title: 'Transparent Process', desc: 'Clear weighing, pricing and documentation at every step.', Icon: ShieldCheck },
              { title: 'Reliable Service', desc: 'Punctual pickups, instant payments and professional staff.', Icon: CheckCircle2 },
              { title: 'Eco-Friendly Recycling', desc: 'Proper recycling that protects the environment and reduces waste.', Icon: Leaf },
            ].map((item) => (
              <div key={item.title} className="bg-white rounded-3xl p-7 shadow-[0_4px_30px_rgba(6,78,59,0.04)] ring-1 ring-slate-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-glow to-emerald-pale/40 flex items-center justify-center mb-5">
                  <item.Icon className="w-6 h-6 text-emerald-brand" />
                </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-10 text-center relative z-10">
          ...
          <div className="inline-flex items-center gap-3 px-5 py-3 rounded-2xl bg-white/10 ring-1 ring-white/20 mb-10">
            ...
            <div className="text-left">
              <div className="text-white font-extrabold text-sm md:text-base">Mahadev Poddar</div>
              <div className="text-emerald-pale/80 text-xs md:text-sm">Owner — PODDAR Scrap & Recycling</div>
              <a href="tel:9903331876" className="inline-flex items-center gap-1.5 mt-1 text-white font-bold text-xs md:text-sm tracking-wide hover:text-emerald-soft transition-colors">
                <Phone className="w-3 h-3" /> 9903331876
              </a>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[32px] overflow-hidden shadow-[0_20px_60px_rgba(6,78,59,0.08)] ring-1 ring-slate-100">
            <div className="relative h-[320px] md:h-[420px] bg-gradient-to-br from-emerald-pale/30 via-emerald-glow to-emerald-pale/20 overflow-hidden">
              ...
              <div className="absolute bottom-6 left-6 md:bottom-8 md:left-8 bg-white/90 nav-glass rounded-2xl px-5 py-4 shadow-xl max-w-md">
                <h3 className="font-display font-bold text-lg text-ink mb-1">PODDAR — Kolkata Office</h3>
                ...
                <p className="text-sm text-slate-700 font-semibold mb-3">
                  Owner: <a href="tel:9903331876" className="text-emerald-brand hover:text-emerald-deep transition-colors font-bold">Mahadev Poddar — 9903331876</a>
                </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <a href="tel:9903331876" className="flex items-center gap-4 p-5 rounded-2xl bg-white shadow-[0_4px_20px_rgba(6,78,59,0.05)] ring-1 ring-slate-100 hover:shadow-md hover:-translate-y-0.5 transition-all group">
                  ...
                  <div>
                    ...
                    <div className="text-lg font-extrabold text-ink">Mahadev Poddar</div>
                    <div className="text-sm font-bold text-emerald-brand group-hover:text-emerald-deep transition-colors">9903331876</div>
                  </div>
                </a>
              </div>
            </div>
            ...
            <div className="bg-white rounded-[32px] p-7 md:p-10 shadow-[0_20px_60px_rgba(6,78,59,0.08)] ring-1 ring-slate-100">
              <h3 className="font-display font-extrabold text-2xl md:text-3xl text-ink mb-2">Get a Scrap Quote</h3>
              <p className="text-slate-500 text-sm mb-8">Fill in the details below and we will reach out quickly.</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-slate-400">
                <li>
                  <span className="text-slate-300 font-semibold">Owner:</span> Mahadev Poddar
                  <a href="tel:9903331876" className="block hover:text-white transition-colors">9903331876</a>
                </li>
            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-3">
                <a href="tel:9835627586" className="inline-flex items-center gap-1.5 bg-emerald-deep hover:bg-emerald-brand text-white text-xs font-bold px-3.5 py-2 rounded-full transition-colors">
                  <Phone className="w-3.5 h-3.5" /> 9835627586
                </a>
                <a href="tel:9903331876" className="inline-flex items-center gap-1.5 bg-white/10 hover:bg-white/20 text-white text-xs font-bold px-3.5 py-2 rounded-full transition-colors">
                  <Phone className="w-3.5 h-3.5" /> Owner 9903331876
                </a>
              </div>
            </div>
          </div>
